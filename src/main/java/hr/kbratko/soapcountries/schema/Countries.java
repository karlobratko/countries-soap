...
@XmlType(
  name = Countries.Constants.xmlTypeName,
  propOrder = {
    Countries.Fields.countries
  }
)
@XmlRootElement(name = Countries.Constants.xmlRootElementName)
@AllArgsConstructor
@NoArgsConstructor
@Builder
@Getter
...
public class Countries {
  ...
  public static Countries from(Collection<Country> countries) {
  ...
  public static class Constants {
    ...
    public static final String xmlRootElementName = "countries";
